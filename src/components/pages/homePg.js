      ...
      <div>
        ...
        <div className="homepageDivider">
          <div className="titlePos">
              <span id="home-content1" style={{marginLeft: "-30%", position: "absolute", marginTop: "6%"}}>Start A New Journey in Victoria</span>
              <button className="button1"  style={{marginLeft: "5%", position: "absolute", marginTop: "15%"}}>
        ...
        <div className="homepageDivider2">
          <div className="IconDivider">
            <div className="SingleIcon">
              <p className="IconP" style={{ marginLeft: "-20%", fontSize:"21px", width: "120%" }}>
            ...
            <div className="SingleIcon">
              <p className="IconP" style={{marginLeft: "-2%", fontSize:"21px", width: "120%"}}>Percentage of Chinese Students in VIC</p>
            ...
            <div className="SingleIcon">
              <p className="IconP" style={{ marginLeft: "20%" , fontSize:"21px"}}>
                Expect to increase
              </p>
