...
<div className="headerBg" style={{backgroundImage:`url(${learnBg}`, backgroundSize:"cover", color:"#EC7F6A"}}>Australia Slang Game</div>
          ...
          {quizzes.length ? index.map((i, key) => {
            return (
              <div key={key} className="slangcard">
                <div style={{backgroundColor: colors[key], borderRadius: "23px", border: "3px solid", height: "12rem"}} className="content">
                  <div className="front">
                    <p style={{position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)"}}>{quizzes[i].Slang}</p>
                    <br></br>
                  </div>

                  <div style={{backgroundColor: colors[key], borderRadius: "23px", border: "3px solid", height: "12rem"}} className="back">
                    <p className="description" style={{position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", overflowY: "scroll"}}>
                      {quizzes[i].Meaning}
                    </p>
                  </div>
                </div>
    ...
    <div className="slangTotal" style={{width: "700px", marginLeft: "26%"}}>
