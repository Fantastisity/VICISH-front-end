...
//             width:"fit-content",
            display: "block"
             ...
             <div style={{width:"320px", height:"300px", backgroundColor:"#FFF4E2"}}>
             <p style={{padding: "2%", fontWeight: "600"}}>
             ...
             <div className="statRow">
             <div style={{width:"320px", height:"300px", backgroundColor:"#F0AB98"}}>
             <p style={{padding: "2%", fontWeight: "600"}}>
             ...
             <div style={{width:"320px", height:"300px", backgroundColor:"#EC7F6A"}}>
             <p style={{padding: "2%", fontWeight: "600"}}>
