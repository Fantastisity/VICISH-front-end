...
export const faqs = [
    ...
    },
    {
      ...
      <div>
        ...
        <p style={{marginLeft: "-12px", fontSize: "17px"}}>
          Full fare ($6 for myki card)
          <ol style={{marginLeft: "50px"}}>
          <li style={{fontSize: "17px"}}>Adults aged 19 and over with no concession entitlement</li>
          <li style={{fontSize: "17px"}}>International visitors aged 19 and over</li>
          </ol>
          Concession ($3 for myki card)
          <ol style={{marginLeft: "50px"}}>
          <li style={{fontSize: "17px"}}>Cardholders of a Victorian Health Care Card, Australian Pensioner Concession Card or PTV ID 
            (Primary, Secondary, Tertiary or Asylum Seeker)</li>
          </ol>
          Child ($3 for myki card)
          <ol style={{marginLeft: "50px"}}>
          <li style={{fontSize: "17px"}}>Children aged 5 to 18 (including children from other states and international visitors)</li>
          <li style={{fontSize: "17px"}}>Children aged 16 and under don't need to carry proof of age</li>
          <li style={{fontSize: "17px"}}>Teenagers aged 17 and 18 must carry government-issued proof of age ID (such as a passport, learner permit, or Proof of Age card), 
    ...
    },
    {
      ...
      <ol style={{marginLeft: "50px", fontSize: "17px"}}>
      <li style={{fontSize: "17px"}}>Free Tram Zone (applies to tram only)</li>
      <li style={{fontSize: "17px"}}>Zone 1</li>
      <li style={{fontSize: "17px"}}>Zone 2</li>
      <li style={{fontSize: "17px"}}>Zone 1/2 boundary overlap</li>
      </ol>
      </div>,
    },
    {
      ...
      answer:
        <p style={{marginLeft: "-12px", fontSize: "17px"}}>
          ...
          <ol style={{marginLeft: "50px"}}>
      <li style={{fontSize: "17px"}}>a full-time international student</li>
      <li style={{fontSize: "17px"}}>enrolled in a bachelor or associate degree, diploma or advanced diploma</li>
      <li style={{fontSize: "17px"}}>studying at an educational institute that’s signed up to the iUSEpass program.</li>
      </ol>
        </p>,
    },
  ];
